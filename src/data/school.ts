...
export const SCHOOL: SchoolData = {
  ...
  principalMessage: {
    enabled: true,
    eyebrow: "Principal Words",
    title: "Principal Words",
    subtitle: "Core vision and philosophy of Al-Falah High School",
    animatedLine: "Character. Nation. Success. Overall Development.",
    valuesHeading: "Our guiding values",
    valuesDescription: "The principles that shape everyday learning at Al-Falah.",
    body: [
      "We are here to build your character, image, position which leads to paradise.",
      "We are here to build our nation India as we are true Indians.",
      "Al-Falah itself means success — here and hereafter.",
      "Al-Falah mentors do here your overall development that nurture you — how to live with parents, elders, neighbours and friends."
    ],
    authorLabel: "Principal",
    authorLocation: "Al-Falah High School",
    valueCards: [
      { label: "Character", icon: "Sparkles" },
      { label: "Nation Building", icon: "Users" },
      { label: "Success", icon: "Compass" },
      { label: "Development", icon: "GraduationCap" },
    ],
    image: null,
    imageAlt: null,
  },
  ...
  /* ── School Notice Board (Max 3 PDFs) ── */
  noticeBoard: {
    enabled: true,
    eyebrow: "Downloads",
    heading: "School Notice Board",
    subtitle: "Download the latest school circulars and important documents.",
    maxItems: 3,
    notices: [
      {
        id: "notice-pdf-1",
        title: "Latest School Circular",
        description: "Important updates and guidelines for the current academic session.",
        isActive: true,
        order: 1,
        pdf: {
          label: "Download Circular",
          file: "/pdfs/sample-circular.pdf",
          uploadedDate: "2026-06-10",
        },
      },
      {
        id: "notice-pdf-2",
        title: "Admissions Information 2026-27",
        description: "Details regarding admission procedures, required documents, and important dates.",
        isActive: true,
        order: 2,
        pdf: {
          label: "Download Admissions Info",
          file: "/pdfs/admissions-info.pdf",
      ...
      },
      {
        ...
        description: "Schedule of examinations, holidays, and school events for the year.",
        isActive: true,
        order: 3,
        pdf: {
          label: "Download Calendar",
          file: "/pdfs/academic-calendar.pdf",
